...
namespace Mediapipe.Unity
{
  public class Bootstrap : MonoBehaviour
  {
    ...
    [Header("Listening to")]
    [SerializeField] private BootstrapEventChannelSO _boostrapEventChannel;
    private bool _isGlogInitialized;

    private void OnEnable()
    {
      var _ = StartCoroutine(Init());
      _boostrapEventChannel.OnEventRaised += GetBoostrap;
    }
    ...
    private Bootstrap GetBoostrap()
    {
      return GetComponent<Bootstrap>();
    }
