...
{
    public class AcupunturePointHandConfig : ModalContents
    {
        ...
        private AcupuncturePointHandSolution _solution;
        ...
        private void Start()
        {
            _solution = GameObject.Find("Solution").GetComponent<AcupuncturePointHandSolution>();
            InitializeContents();
        }
