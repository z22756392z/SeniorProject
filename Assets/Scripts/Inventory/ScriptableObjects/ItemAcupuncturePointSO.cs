...
public class ItemAcupuncturePointSO : ItemSO
{
	...
	public void Setup(string titleKeyID, string descritpionKeyID, ItemTypeSO itemType , string disease, float offset_x, float offset_y, int rel_position, float customize,GameObject AcupuncturePointPrefab, string localizedSpriteID)
    {
